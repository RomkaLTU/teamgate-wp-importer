 ...
 * 
 * TEAMGATEIM->settings->get_plugin_name();
 * 
 * HELPER COMMENT END
 */

/**
 * Class Teamgate_Importer_Settings
 *
 * This class contains all of the plugin settings.
 * Here you can configure the whole plugin data.
 *
 * @package		TEAMGATEIM
 * @subpackage	Classes/Teamgate_Importer_Settings
 * @author		Codesomelabs
 * @since		1.0.0
 */
class Teamgate_Importer_Settings{
	...
	/**
	 * Our Teamgate_Importer_Settings constructor 
	...
	function __construct(){
		...
		$this->plugin_name = TEAMGATEIM_NAME;
	}
	...
	public function get_plugin_name(){
		return apply_filters( 'TEAMGATEIM/settings/get_plugin_name', $this->plugin_name );
	}
}
